...
def partes_numerico_un (*args, **kwargs):
    ...
    if (precisao_grafico >= 20):
        system('g++ ./magia_cpp/partes_aproximado.cpp -o ./magia_cpp/partes_aproximado')
        system(f'.\magia_cpp\partes_aproximado {e} {precisao_grafico} {limite_inferior} {limite_superior} {parametro_final}')

        with open ("./magia_cpp/partes_aproximado_saida_dados.txt","r") as resultados:
