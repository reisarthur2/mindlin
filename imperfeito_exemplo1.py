...
def imperfeito_analitico (*args, **kwargs):
    ...
    if (precisao_grafico >= 20):
        system('g++ ./magia_cpp/imperfeito_exemplo1.cpp -o ./magia_cpp/saidas_e_executaveis/imperfeito_exemplo1')
        system(f'.\magia_cpp\saidas_e_executaveis\imperfeito_exemplo1 {e} {precisao_grafico} {limite_inferior} {limite_superior} {parametro_final} {beta}')

        with open ("./magia_cpp/saidas_e_executaveis/imperfeito_exemplo_saida_dados.txt","r") as resultados:
