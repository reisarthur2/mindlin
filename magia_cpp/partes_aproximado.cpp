...
int main (int argc, char* argv[]) {
    ...
    auto funcao_F = [funcao_f](long double x) -> long double{
        ...
        ;};
    //constantes----------------------
    long double a_chapeu = 1/(integral([funcao_a,E](long double y) -> long double {return 1/funcao_a(y/E);}));
    
    //condicional para botar funcao_a******************
    if  (stoi (argv[10])){saida_2 = criador_grafico_json (saida_2,funcao_a,"a_numerico",superior/E,inferior/E,precisao_grafico);}
    ...
    if (stoi (argv[5]) or stoi (argv[6]) or stoi (argv[7]) or stoi(argv[9])){
        ...
        if (stoi (argv[6]) or stoi (argv[7]) or stoi(argv[9])){
            ...
            if (stoi(argv[8])){saida_2 = criador_grafico_json (saida_2,N1,"N1pn",superior/E,inferior/E,precisao_grafico_2);}
            ...
            if (stoi(argv[7]) or stoi(argv[9])){
                ...
                //condicional para N2*********************
                if (stoi(argv[9])){saida_2 = criador_grafico_json (saida_2,N2,"N2pn",superior/E,inferior/E,precisao_grafico_2);}
            }
        }
    }
